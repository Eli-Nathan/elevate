...
?>
        ...
        <div class="head headNotHome serviceHead col-sm-12">
            <div class='headSub col-sm-12 text-center'>
                ...
                <p class='text-center'>From humble beginings...</p>
            </div>
        </div>
        <!-- /.Head -->
        <div class="servicesPage col-sm-12">
            <div class='serviceBlock col-md-3 col-sm-6 text-center'>
                <a href='<?php echo $rootPath; ?>services/web-design/'><img src='<?php echo $rootPath; ?>images/startup.png' alt='Web Design Image'>
                    <h4>Web Design</h4></a>
