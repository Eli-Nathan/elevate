<?php 
        ...
        $pageTitle = 'Den, Glasgow Web Design';
...
?>
<!-- Head section -->
<div class="head headDarken headNotHome col-sm-12" style='background:url(<?php echo $rootPath; ?>images/den.png); background-size:100%; background-position:center'>
    <div class='headSub  col-sm-12 text-center'> <a href='<?php echo $rootPath; ?>' title='Home Page'><img src='<?php echo $rootPath; ?>images/elevate.png' alt='Elevate Design' /></a>
        <h2 class='text-center'>Den, Glasgow</h2>
        <p class='text-center'>Bar & Restaurant, Bearsden</p>
    </div>
</div>
<!-- /.Head -->
<div class="ourWork workSingle col-sm-12">
    ...
    <div class='workImg col-sm-5'>
        <img src='/elevate/images/mock-up2.png' alt='Den, Glasgow Responsive Web Design' />
    </div>    
</div>
<?php
    $theWork = 'den';
