<?php 
        ...
        $pageTitle = 'Perthshire Joiner Web Design';
...
?>
<!-- Head section -->
<div class="head headDarken headNotHome col-sm-12" style='background:url(<?php echo $rootPath; ?>images/dave.png); background-size:100%; background-position:center'>
    <div class='headSub  col-sm-12 text-center'> <a href='<?php echo $rootPath; ?>' title='Home Page'><img src='<?php echo $rootPath; ?>images/elevate.png' alt='Elevate Design' /></a>
        <h2 class='text-center'>Perthshire Joiner</h2>
        <p class='text-center'>Perthshire based Joiner & Labourer</p>
    </div>
</div>
<!-- /.Head -->
<div class="ourWork workSingle col-sm-12">
    <div class='workText col-sm-7'>
        <h3>Perthshire Joiner</h3>
    ...
    <div class='workImg col-sm-5'>
        <img src='/elevate/images/dave.png' alt='Perthshire Joiner Responsive Web Design' />
    </div>    
</div>
<?php
    $theWork = 'dave';
